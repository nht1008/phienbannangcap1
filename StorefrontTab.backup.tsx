...
const ProductCard = ({
  ...
  return (
    <Card
      className="overflow-hidden group transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 bg-gradient-to-br from-white via-slate-50 to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-700 border-2 hover:border-primary/50 hover:bg-gradient-to-br hover:from-white hover:via-blue-50 hover:to-purple-50 dark:hover:from-slate-800 dark:hover:via-blue-950 dark:hover:to-purple-950"
    >
      <CardHeader className="p-0 relative">
        <div className="aspect-square w-full overflow-hidden relative group-hover:bg-gradient-to-t group-hover:from-black/20 group-hover:to-transparent transition-all duration-500" onClick={() => onViewDetails(product)}>
          {hasFullAccessRights && (
            <Button
              variant="destructive"
              size="icon"
              className="absolute top-3 right-3 z-20 h-8 w-8 rounded-full shadow-lg backdrop-blur-sm bg-red-500/80 hover:bg-red-600 transition-all duration-300 hover:scale-110"
              onClick={async (e) => {
                e.stopPropagation();
                try {
          ...
          {/* Stock status badge with compact design */}
          <div className="absolute top-2 right-2 z-20">
            {hasFullAccessRights && (
              <div className="mb-8"> {/* Add margin to avoid overlap with remove button */}
                <div className={`text-xs font-medium px-2 py-1 rounded-md shadow-md backdrop-blur-sm transition-all duration-300 ${
                  hasStock 
          ...
          <Image
            ...
            className="object-cover w-full h-full transition-all duration-700 group-hover:scale-125 group-hover:rotate-1 filter group-hover:brightness-110 group-hover:contrast-110"
            onError={(e) => { (e.target as HTMLImageElement).src = 'https://placehold.co/400x400.png'; }}
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-80 group-hover:opacity-70 transition-all duration-500" />
          
          {/* Enhanced gradient overlay for better text visibility */}
          <div className="absolute inset-0 bg-gradient-to-t from-purple-900/50 via-transparent to-blue-900/30 opacity-0 group-hover:opacity-100 transition-all duration-500" />
          ...
          {hasFullAccessRights && onThumbnailClick && (
            <Button
              variant="secondary"
              size="icon"
              className="absolute top-3 left-3 z-10 h-8 w-8 opacity-0 group-hover:opacity-100 transition-all duration-300 backdrop-blur-sm bg-white/80 hover:bg-white shadow-lg"
          ...
          <div className="absolute inset-0 p-3 flex flex-col">
            <div className="flex-grow">
              <div className="flex flex-col gap-1 items-start">
                {isTopSeller && (
                    <div className="flex items-center bg-gradient-to-r from-orange-500 to-red-500 text-white text-xs font-medium px-2 py-1 rounded-md shadow-md backdrop-blur-sm">
            ...
            <div className="text-white drop-shadow-lg">
              <CardTitle className="text-base font-bold whitespace-normal break-words mb-1.5 text-shadow-md line-clamp-2" title={product.name}>
                  🌸 {product.name}
              </CardTitle>
              <div className="bg-gradient-to-r from-yellow-400 via-amber-400 to-orange-400 text-black text-sm font-bold px-2 py-1.5 rounded-lg shadow-md backdrop-blur-sm border border-yellow-300">
                {getPriceDisplay()}
              </div>
            </div>
          </div>
        ...
        <div className="relative flex-1">
          ...
          {filteredAndSortedGroups.length > 0 ? (
            ...
            <div className={`text-center py-16 ${
              ...
              <div className="flex flex-col items-center gap-4 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 rounded-2xl p-8 border-2 border-dashed border-gray-300 dark:border-gray-600">
                <div className="text-6xl mb-4">🔍</div>
                <h3 className="text-2xl font-bold text-gray-700 dark:text-gray-300">Không tìm thấy sản phẩm</h3>
                <p className="text-gray-500 dark:text-gray-400 text-center max-w-md">
                  {selectedFilters.length > 0 || searchTerm ? 
                    `Không có sản phẩm nào phù hợp với bộ lọc "${[...selectedFilters, searchTerm].filter(Boolean).join(', ')}".` : 
                    'Hiện tại gian hàng chưa có sản phẩm nào. Vui lòng quay lại sau!'
                  }
                </p>
                {(selectedFilters.length > 0 || searchTerm) && (
                  <Button 
            ...
            <div className="text-left">
              <div className="text-white/90 space-y-2">
                <p className="text-lg font-medium drop-shadow-md">
                  📍 Địa chỉ: Chợ Hoa-Mê Linh-Hà Nội
                </p>
                <p className="text-lg font-medium drop-shadow-md">
                  📞 Hotline: 0976778612
                </p>
            ...
            <div className="text-right">
              <div className="flex flex-col items-end space-y-3">
                <div className="flex justify-end">
                  {/* TODO: Thay thế bằng logo thực từ cài đặt */}
                  <div className="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
                    <span className="text-3xl">🌸</span>
                  </div>
                  {/* Khi có logo thực từ cài đặt, sử dụng:
                  <Image 
                    src={logoUrl} 
                  ...
                  */}
                  ...
                  <a href="#" className="bg-white/20 backdrop-blur-sm px-3 py-2 rounded-full text-white font-semibold hover:bg-white/30 transition-all duration-300 flex items-center gap-2">
          ...
          <div className="text-center mb-6">
            <div className="flex flex-col items-center space-y-3">
              ...
              <div className="flex items-center gap-4 justify-center">
                <a href="#" className="bg-white/20 backdrop-blur-sm p-3 rounded-full text-white font-semibold hover:bg-white/30 transition-all duration-300 flex items-center justify-center" title="Facebook">
                  <span className="text-2xl">�</span>
                </a>
                <a href="#" className="bg-white/20 backdrop-blur-sm p-3 rounded-full text-white font-semibold hover:bg-white/30 transition-all duration-300 flex items-center justify-center" title="Zalo">
                  <span className="text-2xl">�</span>
                </a>
              </div>
            </div>
